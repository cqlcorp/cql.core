...
namespace Cql.Core.Owin.IdentityData
{
    ...
    {
        public UserRoleRepository(DatabaseConnection connection) : base(connection)
        {
        }
        ...
        public virtual Task AddToRoleAsync(IdentityUser user, string roleName)
        {
            ...
            return Execute(db => db.ExecuteAsync("dbo.spUserRoles_add", args, commandType: CommandType.StoredProcedure));
        }
        ...
        public virtual async Task<IList<string>> GetRolesAsync(IdentityUser user)
        {
            ...
            const string sql = "SELECT r.Name " +
                               ...
                               "JOIN dbo.AspNetUserRoles u ON u.RoleId = r.Id " +
                               "WHERE u.UserId = @UserId";

            var q = await Execute(db => db.QueryAsync<string>(sql, args));
        ...
        public virtual Task<bool> IsInRoleAsync(IdentityUser user, string roleName)
        {
            ...
            return Execute(db => db.ExecuteScalarAsync<bool>("dbo.spUserRoles_exists", args, commandType: CommandType.StoredProcedure));
        }
        ...
        public virtual Task RemoveFromRoleAsync(IdentityUser user, string roleName)
        {
            ...
            return Execute(db => db.ExecuteAsync("dbo.spUserRoles_remove", args, commandType: CommandType.StoredProcedure));
        }
    }
}

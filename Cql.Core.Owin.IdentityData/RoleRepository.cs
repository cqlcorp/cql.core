...
namespace Cql.Core.Owin.IdentityData
{
    ...
    {
        public RoleRepository(DatabaseConnection connection) : base(connection)
        {
        }
        ...
        public virtual Task CreateAsync(IdentityRole role)
        {
            ...
            const string sql = "INSERT INTO dbo.AspNetRoles (Id, Name) " +
                               "VALUES (@Id, @Name)";
        ...
        public virtual Task<IdentityRole> FindByIdAsync(int roleId)
        {
            ...
            return Execute(db => db.QueryFirstOrDefaultAsync<IdentityRole>(sql, args));
        }
        ...
        public virtual Task UpdateAsync(IdentityRole role)
        {
            ...
            const string sql = "UPDATE dbo.AspNetRoles" +
                               "SET" +
                               " Name = @Name " +
                               "WHERE Id = @Id";

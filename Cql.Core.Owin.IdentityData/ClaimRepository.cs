...
namespace Cql.Core.Owin.IdentityData
{
    ...
    {
        public ClaimRepository(DatabaseConnection connection) : base(connection)
        {
        }
        ...
        public virtual Task AddClaimAsync(int userId, Claim claim)
        {
            ...
            const string sql = "INSERT INTO dbo.AspNetUserClaims (UserId, ClaimType, ClaimValue)" +
...
";
        ...
        public virtual async Task<IList<Claim>> GetClaimsAsync(int userId)
        {
            ...
            const string sql = "SELECT * FROM dbo.AspNetUserClaims " +
                               "WHERE UserId = @UserId";

            var q = await Execute(db => db.QueryAsync<IdentityClaim>(sql, args));
        ...
        public virtual Task RemoveAllClaimsOfTypeAsync(int userId, string claimType)
        {
            ...
            const string sql = "DELETE FROM dbo.AspNetUserClaims " +
